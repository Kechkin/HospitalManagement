...
class TestGetPatientStatus:
    ...
    def test_patient_status(self):
        self.service._list_of_patients = generate_patients_with_statuses_from_zero_to_three(30, 2)
        assert self.app.get_status_patient(15) == 'Статус пациента: Слегка болен'

    def test_different_statuses(self):
        self.service._list_of_patients = generate_patients_with_statuses_from_zero_to_three(4, 3)
    ...
    def test_input_text(self):
        self.service._list_of_patients = generate_patients_with_statuses_from_zero_to_three(2, 3)
    ...
    def test_error_values(self):
        self.service._list_of_patients = generate_patients_with_statuses_from_zero_to_three(10, 3)
